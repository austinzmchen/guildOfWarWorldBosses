...
class WBDrawerViewController: UIViewController {
    ...
    fileprivate var drawerItems: [WBDrawerItem] = {
        return [
            WBDrawerItem(normalImageName: "icTimers", selectedImageName: "", title: "Boss Timers", storyboardFileName: "Timer", storyboardID: "timerNavVC"),
            ...
            WBDrawerItem(normalImageName: "icStorage", selectedImageName: "", title: "Storage",
                         storyboardFileName: "Storage", storyboardID: "storageNavVC")
            ]
    }()
